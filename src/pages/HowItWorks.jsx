...
export default function HowItWorks() {
  ...
  return(
    <div className="font-google bg-brown text-white">
      ...
      <p className="text-3xl md:text-5xl font-bold mb-3">It starts with connections</p>

      <p className="text-md md:text-xl">ShareHarvest is a money-free 
        platform for connecting like-minded people who want to promote sustainable living, 
        reduce wastage and share their passion for food and gardening. 
      </p>
      </div>  
